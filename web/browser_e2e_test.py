...
def main() -> int:
    ...
    try:
        ...
        with sync_playwright() as p:
            ...
            page.click("#startBtn")
            expect(page.get_by_role("heading", name="Full SEO Audit (360 Degree)")).to_be_visible()
            expect(page.locator("#summaryView").get_by_text("SEO On-Page & HTML Signals: Image alt text gaps", exact=True)).to_be_visible(timeout=12000)
