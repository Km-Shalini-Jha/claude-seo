...
MODULES: dict[str, dict[str, Any]] = {
    "overview": {
        "label": "SEO On-Page & HTML Signals",
    ...
    "full-audit": {
        "label": "Full SEO Audit (360 Degree)",
        "category": "Audit & On-Page",
    ...
    "seo-images": {
        "label": "SEO Images & Alt Text Optimization",
        "category": "Audit & On-Page",
        "description": "Audits on-page images, missing alt tags, image file paths, and SERP visual search readiness.",
        "script": "parse_html.py",
        "args": lambda url: ["--url", url, "--json"],
        "timeout": 45,
    },
    "sitemap": {
        "label": "SEO XML Sitemap Discovery",
        "category": "Technical & Schema",
        "description": "Discovers declared and common XML sitemap locations, validating lastmod and indexability.",
    ...
    "preload": {
        "label": "Preload & Critical Resource Hints",
        "category": "Performance",
    ...
    "ux": {
        "label": "Search Experience & UX Heuristics (SXO)",
        "category": "Audit & On-Page",
        "description": "Reviews page experience, readability, interaction, touch targets, and conversion clarity.",
        "script": "agent_ux_check.py",
        "args": lambda url: [url, "--json"],
        "timeout": 120,
    },
    "visual": {
        "label": "Visual Layout & Viewport Rendering",
        "category": "Audit & On-Page",
        "description": "Uses a browser render to inspect visible layout, mobile responsiveness, and viewport issues.",
        "script": "analyze_visual.py",
        "args": lambda url: [url, "--json"],
        "timeout": 120,
    },
    "content": {
        "label": "Content Quality & E-E-A-T Audit",
        "category": "Content & AI",
        "description": "Evaluates specificity, density, repetition, thin-content risk, and author proof points.",
        "compound": "content_quality",
        "timeout": 90,
    },
    "seo-content-brief": {
        "label": "SEO Content Brief Generator",
        "category": "Content & AI",
        "description": "Generates structured content briefs with target LSI entities, target word counts, and heading outlines.",
        "compound": "ai_content_studio",
        "timeout": 90,
    },
    "seo-cluster": {
        "label": "Semantic Keyword Clustering",
        "category": "Content & AI",
        "description": "Clusters SERP search intent, TF-IDF term frequencies, and subtopic content pillars.",
        "script": "nlp_analyze.py",
        "args": lambda url: [url, "--json"],
        "timeout": 90,
    },
    "local": {
        "label": "Local SEO & Business Signal Lint",
        "category": "Local & Maps",
    ...
    "seo-maps": {
        "label": "Google Maps & Local Pack Intelligence",
        "category": "Local & Maps",
        "description": "Audits local map pack rankings, NAP consistency, and geo-location coordinates.",
        "script": "gbp_deprecation_lint.py",
        "args": lambda url: [url, "--json"],
        "timeout": 75,
    },
    "schema-commerce": {
        "label": "Ecommerce Schema & Product Validation",
        "category": "Technical & Schema",
        "description": "Validates product, offer, pricing, and merchant structured data from page source.",
        "script": "schema_ecommerce_validate.py",
        "args": lambda url: [url, "--json"],
        "timeout": 75,
    },
    "schema-generator": {
        "label": "SEO Schema.org Code Generator",
        "category": "Technical & Schema",
    ...
    "lcp": {
        "label": "LCP Subpart Metric Breakdown",
        "category": "Performance",
        "description": "Breaks down LCP field data into TTFB, Resource Load Delay, and Render Delay when Google API key is set.",
        "script": "lcp_subparts.py",
        "args": lambda url: [url, "--json"],
        "timeout": 75,
    },
    "indexing": {
        "label": "Instant Indexing Submission (IndexNow)",
        "category": "Indexing & Backlinks",
    ...
    "backlinks-verify": {
        "label": "Backlink Profile Audit & Verification",
        "category": "Indexing & Backlinks",
    ...
    "nlp-content": {
        "label": "NLP Entity & Keyword Density Analysis",
        "category": "Content & AI",
    ...
    "seo-geo": {
        "label": "AI Search & GEO Optimization (Generative Engine)",
        "category": "Strategy & AI",
        "description": "Audits AI Overviews, LLM citation probability, and Generative Engine Optimization factors.",
        "script": "nlp_analyze.py",
        "args": lambda url: [url, "--json"],
        "timeout": 90,
    },
    "seo-plan": {
        "label": "SEO Strategic Action Plan",
        "category": "Strategy & AI",
        "description": "Generates strategic SEO roadmaps categorized by Quick Wins, Technical Fixes, and Content Growth.",
        "script": "drift_compare.py",
        "args": lambda url: [url, "--json"],
        "timeout": 90,
    },
    "seo-flow": {
        "label": "FLOW Framework SEO Strategy",
        "category": "Strategy & AI",
        "description": "Applies the FLOW framework (Find, Leverage, Optimize, Win) to maximize ROI.",
        "compound": "full_audit",
        "timeout": 120,
    },
    "seo-hreflang": {
        "label": "Hreflang & International SEO Audit",
        "category": "Technical & Schema",
        "description": "Audits multi-language, multi-region hreflang tags, self-referential links, and regional canonicals.",
        "script": "parse_html.py",
        "args": lambda url: [url, "--json"],
        "timeout": 60,
    },
    "seo-programmatic": {
        "label": "Programmatic SEO Architecture",
        "category": "Technical & Schema",
        "description": "Audits dynamic URL patterns, database page generation, and thin programmatic page risks.",
        "script": "parse_html.py",
        "args": lambda url: [url, "--json"],
        "timeout": 60,
    },
    "seo-competitor-pages": {
        "label": "Competitor Comparison Page Audit",
        "category": "Strategy & AI",
        "description": "Audits vs-competitor landing pages, feature comparison matrices, and commercial intent signals.",
        "script": "nlp_analyze.py",
        "args": lambda url: [url, "--json"],
        "timeout": 90,
    },
...
def build_findings(module: str, output: dict[str, Any] | None, error: str | None = None, url: str = "https://example.com") -> list[dict[str, str]]:
    ...
    if module == "overview" and isinstance(data, dict):
        ...
        if data.get("score") is not None:
            ...
            tokens_val = f" ({data['tokens']} content tokens processed)" if data.get("tokens") else ""
            findings.append({"severity": "info", "title": f"Audit Performance Score: {score_val}/100", "detail": f"Overall module evaluation rating: {score_val}/100.{tokens_val}"})
